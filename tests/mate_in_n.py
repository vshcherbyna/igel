...
def main():
    ...
    fen_assert("Rb7",  evaluate(20000, 9, "3Q4/5q1k/4ppp1/2Kp1N1B/RR6/3P1r2/4nP1b/3b4 w - - 0 1"))
    fen_assert("Qh5+",  evaluate(30000, 10, "2qrr1n1/3b1kp1/2pBpn1p/1p2PP2/p2P4/1BP5/P3Q1PP/4RRK1 w - - 0 1"))
