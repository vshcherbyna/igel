...
def non_passing_tests():
    ...
    #
    #   Best move is h5, but igel does not return it
    #   fen_assert("h5",  evaluate(None, "r2q1rk1/1ppnbppp/p2p1nb1/3Pp3/2P1P1P1/2N2N1P/PPB1QP2/R1B2RK1 b - - 0 1"))
    #

    #
    #   Best move is g4, but igel does not return it
    #   fen_assert("g4",  evaluate(60000, "r4k2/pb2bp1r/1p1qp2p/3pNp2/3P1P2/2N3P1/PPP1Q2P/2KRR3 w - - 0 1"))
    #
    
    #
    #   Best move is f4, but igel does not return it
    #
